...
/* 分区名称 */
#define FLASH_DB_KVDB_PART "flashdb"
//#define FLASH_DB_TSDB_PART "flashdb"
...
int flashdb_demo(void)
{
    ...
    { /* KVDB Sample */
         ...
         */
        result = fdb_kvdb_init(&kvdb, "env", FLASH_DB_KVDB_PART, &default_kv, NULL);
    ...
    { /* TSDB Sample */
         ...
         *        NULL: The user data if you need, now is empty.
         */
        result = fdb_tsdb_init(&tsdb, "log", FLASH_DB_TSDB_PART, get_time, 128, NULL);
