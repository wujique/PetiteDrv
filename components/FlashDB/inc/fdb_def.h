...
#ifndef FDB_PRINT
#define FDB_PRINT(...)                 uart_printf(__VA_ARGS__)
#endif
...
#define FDB_DEBUG(...)                 FDB_LOG_PREFIX();FDB_PRINT("(%s:%d) ", __FILE__, __LINE__);FDB_PRINT(__VA_ARGS__);FDB_PRINT("\r\n")
#else
#define FDB_DEBUG(...)
#endif
...
struct fdb_db {
    ...
    union {
       ...
       void *part;        /**< flash partition for saving database */
#endif
