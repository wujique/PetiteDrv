...
#define STREAM_FILE( stream )  ( (FT_FILE*)stream->descriptor.pointer )
                  ...
                  const char*  filepathname )
  {
    ...
    if ( !stream->size )
    {
      //uart_printf(( "99999999FT_Stream_Open:\r\n" ));
      //uart_printf(( " opened %s\r\n", filepathname ));
	  //uart_printf("but zero-sized\r\n");
    ...
    uart_printf( "FT_Stream_Open:" );
    uart_printf( "\t opened %s  successfully! \r\n",filepathname);
	uart_printf("\t %d bytes", stream->size);
