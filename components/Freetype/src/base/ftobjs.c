...
#define GRID_FIT_METRICS
                 ...
                 FT_Stream           *astream )
  {
    ...
    *astream = NULL;
    ...
    if ( FT_NEW( stream ) ) {
		uart_printf("FT_NEW( stream ) fail !\r\n");
      goto Exit;
    }
...
#define FT_COMPONENT  objs
                         ...
                         FT_Bool              test_mac_fonts )
  {
	...
	uart_printf("ft_open_face_internal\r\n");
    ...
    if ( ( args->flags & FT_OPEN_DRIVER ) && args->driver )
    {
	  ...
	  uart_printf("not all modules are drivers, so check...\r\n");
    ...
    else
    {
      ...
      for ( ; cur < limit; cur++ )
      {
        ...
        if ( FT_MODULE_IS_DRIVER( cur[0] ) )
        {
		  ...
		  /* open face：消耗29K+32K 内存   wjq_mask */
          error = open_face( driver, &stream, external_stream, face_index,
                             num_params, params, &face );
          ...
          if ( FT_ERR_NEQ( error, Unknown_File_Format ) ) {
		  	uart_printf("Unknown_File_Format\r\n");
            goto Fail3;
          	}
        }
      }
  ...
  Success:
    ...
    //uart_printf("FT_Open_Face: Creating glyph slot\r\n");
  ...
  Exit:
    ...
    uart_printf(( "FT_Open_Face: Return %d\r\n", error ));
