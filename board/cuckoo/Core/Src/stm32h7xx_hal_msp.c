...
void HAL_DCMI_MspInit(DCMI_HandleTypeDef* hdcmi)
{
  ...
  /* USER CODE END DCMI_MspInit 0 */
    ...
    */
    ...
    //__HAL_LINKDMA(hdcmi,hdmarx,hdma_dcmi_pssi);
    //__HAL_LINKDMA(hdcmi,hdmatx,hdma_dcmi_pssi);
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = GPIO_PIN_3|GPIO_PIN_7|GPIO_PIN_11|GPIO_PIN_12;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF14_LTDC;
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_3|GPIO_PIN_7|GPIO_PIN_11|GPIO_PIN_12);
...
void HAL_SD_MspInit(SD_HandleTypeDef* hsd)
{
  ...
  /* USER CODE BEGIN SDMMC1_MspInit 0 */
	uart_printf("HAL_SD_MspInit SDMMC1!\r\n");
...
/* SAI2 */
  ...
  */
    ...
    */
    ...
    hdma_sai2_b.Instance = DMA1_Stream6;
