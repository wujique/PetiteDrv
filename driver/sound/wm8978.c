 ...
 *@retval:     
 */
static s32 dev_wm8978_writereg(u8 reg, u16 vaule)
{
	DevI2cNode *dev;
 ...
 *@retval:     
 */
s32 dev_wm8978_set_dataformat(u8 Standard, short BitsPerSample)
{
	u16 RegValue = 0;
	...
	RegValue  = Standard<<3;	
	RegValue |= format<<5;
	dev_wm8978_writereg(4, RegValue);
	return 0;
}
...
static s32 dev_wm8978_setting_init(void)
{
	...
	dev_wm8978_inout(WM8978_INPUT_NULL, WM8978_OUTPUT_NULL);
